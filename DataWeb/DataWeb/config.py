...
#
MAIL_USERNAME       =     os.getenv('MAIL_USERNAME',        'dfog22@hotmail.com')
MAIL_PASSWORD       =     os.getenv('MAIL_PASSWORD',        'excalibur')
...
SQLALCHEMY_DATABASE_URI = 'mysql://root:exc@libur@localhost/datacourses'
